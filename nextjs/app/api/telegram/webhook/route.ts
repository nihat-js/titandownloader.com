...
import { downloadFromInstagram } from '@/app/services/Instagram';
...
export async function POST(req: NextRequest,) {
  ...
  console.log({from})
  console.log(`Received message from ${from.first_name} (@${from.username}) ${from.id} : ${text}`);
  ...
  // console.log({text})
  // return;
  let result = await downloadFromInstagram(text)
  ...
  // @ts-expect-error Bilmirem niye error verir
